...
vec4 sampleText(vec2 uv, sampler2D tex) {
...
void main() {
  ...
  vec4 base = sampleText(displaced, uTextTexture);
  float r = sampleText(displaced + split, uTextTexture).r;
  float g = base.g;
  float b = sampleText(displaced - split, uTextTexture).b;
  float a = max(max(sampleText(displaced + split, uTextTexture).a, base.a), sampleText(displaced - split, uTextTexture).a);
